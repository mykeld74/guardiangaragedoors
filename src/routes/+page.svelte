...
<section class="hero">
	<div class="heroContent">
		<h1 class="heroTitle">Keeping Your Door Operating Exceptionally!</h1>
	</div>
</section>
<section class="descriptionContainer">
	<div class="container">
		<p class="description">
			With over {yearsOfExperience} years experience, we are ready to serve any of your garage door needs
			from a tune up to a complete replacement and everything in between! We offer FREE ESTIMATES and
			are excited to take care of you and show you an excellent customer service experience!
		</p>
	</div>
</section>

<!-- Service Selection -->
<section class="serviceSelection">
	<div class="container">
		<h3 class="sectionTitle">What type of service do you need?</h3>
		<div class="serviceButtons">
			<div class="serviceBtnContainer">
				<a href="/free-estimates" class="serviceBtn"
					><div class="serviceBtnIcon">
						<svg viewBox="0 0 100 125">
							<rect class="serviceIcon" x="14.62" y="56.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="24.62" y="56.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="34.62" y="56.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="14.62" y="66.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="24.62" y="66.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="34.62" y="66.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="14.62" y="76.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="24.62" y="76.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="34.62" y="76.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="14.62" y="46.88" width="27.75" height="6"></rect>
							<path
								class="serviceIcon"
							...
							></path>
							<rect class="serviceIcon" x="40.62" y="20.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="53.62" y="20.88" width="27.75" height="6"></rect>
							<rect class="serviceIcon" x="40.62" y="30.88" width="7.75" height="6"></rect>
							<rect class="serviceIcon" x="53.62" y="30.88" width="27.75" height="6"></rect>
							<rect class="serviceIcon" x="53.62" y="40.88" width="27.75" height="6"></rect>
							<rect class="serviceIcon" x="53.62" y="50.88" width="27.75" height="6"></rect>
							<rect class="serviceIcon" x="53.62" y="60.88" width="27.75" height="6"></rect>
						</svg>
					</div>
					<p>Estimate</p></a
				>
			...
			<div class="serviceBtnContainer">
				<a href="/repair" class="serviceBtn"
					><div class="serviceBtnIcon">
						<svg viewBox="0 0 100 125">
							<g>
								<path
			...
			<div class="serviceBtnContainer">
				<a href="/garage-door-openers" class="serviceBtn"
					><div class="serviceBtnIcon">
			...
			<div class="serviceBtnContainer">
				<a href="/replacement" class="serviceBtn"
					><div class="serviceBtnIcon">
						<svg viewBox="0 0 100 125">
							<g>
								<path
...
<section class="reviews" id="reviews">
	...
	<div class="container center">
		...
		<a
			href="https://www.google.com/maps/place/?q=place_id:ChIJfeOYLVuDa4cR8S3k5ibd7i0&hl=en&gl=us"
			target="_blank"
			class="googleReviewLink"
		>
			<span class="googleReviewIcon">
				<svg
					width="25"
					height="26"
					viewBox="0 0 256 262"
...
<style>
	...
	.hero {
		display: grid;
		background: url('https://res.cloudinary.com/bigbeardeddev/image/upload/v1757357903/guardian_repairs/heroBanner3.jpg')
	...
	.heroTitle {
		...
		-webkit-text-stroke: 0.025em rgb(0, 0, 0);
		text-shadow: rgb(119, 119, 119) 2px 2px 5px;
		text-align: center;
		line-height: 1.3;
		text-wrap: balance;
	}
